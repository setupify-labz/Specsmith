          ...
          >
            <div className="p-4 space-y-3" style={{ borderTop: '1px solid var(--ff-border)', backgroundColor: 'var(--ff-bg)' }}>
              ...
              {/*
                ...
                disclosure applies whenever there's at least one part — but
                only in shopping mode; comparison-only selectors render no
                retailer CTA at all, so the disclosure would be talking about
                links that aren't on the page.
              */}
              {showShopping && filtered.length > 0 && (
