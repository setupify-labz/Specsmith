...
// RETIRED — kept only as a rollback reference for one deploy cycle after
// the Supabase Auth migration ships (see AuthContext.tsx). Not imported by
// App.tsx or entry-server.tsx; the app runs on exactly one auth system,
// this one just isn't it anymore. Safe to delete once the migration has
// been live and stable for a cycle. If you're rolling back: swap
// AuthContext.tsx's import back to this file's export — nothing else
// needs to change, since AuthProvider/useAuth here have the same names.
//
