...
// BASE_PATH affects the build's asset URL prefix. Default to "/" rather
// than failing builds in environments (e.g. Cloudflare Pages preview)
// where it wasn't explicitly configured.
